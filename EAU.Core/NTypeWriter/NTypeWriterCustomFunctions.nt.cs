...
namespace EAU.Core.NTypeWriter
{
    class NTypeWriterCustomFunctions
    {
        ...
        private readonly static string[] includedClasses = new string[]
        {
            ...
            "UserAuthentication",
            "Country",
            "ServiceInstanceLoadOption",
            "ServiceInstanceSearchCriteria",
            "UserAuthenticationInfo",
            "MyPaymentsObligationSearchCriteria",
            "SIObligationSearchCriteria",
            "ObligationRequest",
            "ObligationSearchCriteria",
        ...
        private readonly static string[] includedNamespaces = new string[]
        {
            ...
            "EAU.CMS.Models",
            "EAU.CMS.Repositories",
            "EAU.Services.ServiceInstances.Models",
