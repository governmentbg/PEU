...
{
    public interface IDeliveryUnitsRootInfoCache : IDataCacheItems<CachedDataInfo<List<UnitInfo>>, string>
    {
    }

    public class DeliveryUnitsRootInfo : IDeliveryUnitsRootInfo
    {
        private readonly IDeliveryUnitsRootInfoCache _deliveryUnitsInfoCache;

        public DeliveryUnitsRootInfo(IDeliveryUnitsRootInfoCache deliveryUnitsInfoCache)
        {
