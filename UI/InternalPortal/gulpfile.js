const publishFolder = "//ui.dev.local/www/UI/MVR_EAU_Backoffice(PR026198,15.11.2025)/InternalPortal";
const reactFolder = "../../EAU.Web.Admin.App/client-app/src/assets/";
...
function sass() {
    return gulp.src([sourceFolder+sourceFile, sourceFolder])
...
function copyToReact() {
    ...
    return gulp.src([destinationFolder+'css/**/*.*', destinationFolder+'fonts/**/*.*', destinationFolder+'images/**/*.*'], { base: destinationFolder })
