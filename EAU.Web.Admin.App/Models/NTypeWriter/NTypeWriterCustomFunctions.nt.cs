...
namespace EAU.Core.NTypeWriter
{
    class NTypeWriterCustomFunctions
    {
        ...
        {
            "DataServiceLimitStatus",
            "ObjectTypes",
            "ActionTypes",
            "LogActionSearchModes",
            "AuthenticationTypes",
            "UserStatuses",
            "ANDSourceIds",
            "ObligedPersonIdentTypes",
            "PaymentRequestStatuses",
            "DocumentAccessedDataTypes",
        };
        ...
        private readonly static string[] includedClasses = new string[]
        {
            ...
            "LabelTranslation",
            "ServiceTranslation",
            "ServiceGroupSearchCriteria",
            "ServiceGroupTranslation",
            "LDAPUserSearchCritaria",
            "LDAPUser",
            "DataServiceLimitsSearchCriteria",
            "DataServiceLimit",
            "RegistrationDataSearchCriteria",
            "RegistrationData",
            "ActionType",
            "ObjectType",
            "PaymentsObligationsSearchCriteria",
            "PaymentsObligationsData",
            "NotaryInterestsForPersonOrVehicleSearchCriteria",
            "NotaryInterestsForPersonOrVehicleReportData",
            "DocumentAccessedDataValue",
        };
        ...
        private readonly static string[] includedNamespaces = new string[]
        {
            ...
            "EAU.ServiceLimits.Models",
            "EAU.Nomenclatures.Repositories",
            "EAU.DirectoryServices.Models",
            "EAU.Payments.RegistrationsData.Models",
            "EAU.Payments.Reports.Models",
            "EAU.Audit.Models",
            "EAU.Users.Models",
            "EAU.Payments.Obligations.Models",
            "EAU.Payments.PaymentRequests.Models",
            "EAU.Reports.PaymentsObligations.Models",
            "EAU.Reports.NotaryInterestsForPersonOrVehicle.Models",
            "EAU.Audit.Models",
        };
        ...
        public static string getClassProperty(IClass @class, IProperty property, string unwrapedTypeScriptType, string unwrapedTypeScriptArrayItemType, IEnumerable<IType> allReference = null)
        {
            ...
            //Забивка
            if (property.Type.Name == "AdditionalData")
            {
                unwrapedTypeScriptType = "any";
            }

            if (property.Type.Name != "AdditionalData" && (property.Type.IsArray || property.Type.IsCollection))
            {
