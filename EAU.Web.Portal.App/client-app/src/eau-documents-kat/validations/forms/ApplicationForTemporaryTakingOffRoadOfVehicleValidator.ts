...
import { ApplicationForTemporaryTakingOffRoadOfVehicleVM } from "../../models/ModelsAutoGenerated";
import { VehicleDataRequestValidator } from '../VehicleDataRequestValidator';

export class ApplicationForTemporaryTakingOffRoadOfVehicleValidator extends EAUBaseValidator<ApplicationForTemporaryTakingOffRoadOfVehicleVM, DocumentFormValidationContext> {
    constructor() {
        super();
