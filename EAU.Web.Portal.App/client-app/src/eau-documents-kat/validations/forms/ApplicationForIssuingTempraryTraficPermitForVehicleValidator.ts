...
import { ApplicationForIssuingTempraryTraficPermitForVehicleVM } from "../../models/ModelsAutoGenerated";
import { VehicleDataRequestValidator } from '../VehicleDataRequestValidator';

export class ApplicationForIssuingTempraryTraficPermitForVehicleValidator extends EAUBaseValidator<ApplicationForIssuingTempraryTraficPermitForVehicleVM, DocumentFormValidationContext> {
    constructor() {
        super();
