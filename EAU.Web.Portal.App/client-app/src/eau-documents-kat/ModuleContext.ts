...
export interface KatLocalizationErorrs extends LocalizationErorrs {
...
class ModuleContext extends TypedModuleContext<BaseModuleInitializaitonContext, LocalizationResources, KatLocalizationErorrs> {    
    public get moduleName(): string {
        return 'eau-documents-kat';
    }    
}
