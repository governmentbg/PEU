...
import { ApplicationForCommissioningTemporarilySuspendedVehicleVM, OwnerVM, PersonEntityChoiceType } from '../models/ModelsAutoGenerated';
...
export class ApplicationForCommissioningTemporarilySuspendedVehicleManager extends ApplicationFormManagerBase<ApplicationForCommissioningTemporarilySuspendedVehicleVM>{

    //#region ApplicationFormManagerBase

    createDocument(obj: any): ApplicationForCommissioningTemporarilySuspendedVehicleVM {
        return new ApplicationForCommissioningTemporarilySuspendedVehicleVM(obj);
    }
