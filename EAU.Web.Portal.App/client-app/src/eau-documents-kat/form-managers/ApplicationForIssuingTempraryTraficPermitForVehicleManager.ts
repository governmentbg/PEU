...
import { ApplicationForIssuingTempraryTraficPermitForVehicleVM, OwnerVM, PersonEntityChoiceType } from '../models/ModelsAutoGenerated';
...
export class ApplicationForIssuingTempraryTraficPermitForVehicleManager extends ApplicationFormManagerBase<ApplicationForIssuingTempraryTraficPermitForVehicleVM>{

    //#region ApplicationFormManagerBase

    createDocument(obj: any): ApplicationForIssuingTempraryTraficPermitForVehicleVM {
        return new ApplicationForIssuingTempraryTraficPermitForVehicleVM(obj);
    }
