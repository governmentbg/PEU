...
import { ApplicationForTemporaryTakingOffRoadOfVehicleVM, OwnerVM, PersonEntityChoiceType } from '../models/ModelsAutoGenerated';
...
export class ApplicationForTemporaryTakingOffRoadOfVehicleManager extends ApplicationFormManagerBase<ApplicationForTemporaryTakingOffRoadOfVehicleVM>{

    //#region ApplicationFormManagerBase

    createDocument(obj: any): ApplicationForTemporaryTakingOffRoadOfVehicleVM {
        return new ApplicationForTemporaryTakingOffRoadOfVehicleVM(obj);
    }
