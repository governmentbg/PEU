...
import { ApplicationForTerminationOfVehicleRegistrationVM, OwnerVM, PersonEntityChoiceType } from '../models/ModelsAutoGenerated';
...
export class ApplicationForTerminationOfVehicleRegistrationManager extends ApplicationFormManagerBase<ApplicationForTerminationOfVehicleRegistrationVM>{

    //#region ApplicationFormManagerBase

    createDocument(obj: any): ApplicationForTerminationOfVehicleRegistrationVM {
        return new ApplicationForTerminationOfVehicleRegistrationVM(obj);
    }
