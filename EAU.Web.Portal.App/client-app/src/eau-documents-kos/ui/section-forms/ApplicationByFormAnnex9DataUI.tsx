...
import { ApplicationByFormAnnex9DataVM } from "../../models/ModelsAutoGenerated";

interface ApplicationByFormAnnex9DataProps extends BaseProps, ApplicationFormManagerProps {
}

export class ApplicationByFormAnnex9DataImpl extends EAUBaseComponent<ApplicationByFormAnnex9DataProps, ApplicationByFormAnnex9DataVM> {
...
export const ApplicationByFormAnnex9DataUI = withDocumentFormManager(ApplicationByFormAnnex9DataImpl)