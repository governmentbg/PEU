...
export interface MigrLocalizationErorrs extends LocalizationErorrs {
...
class ModuleContext extends TypedModuleContext<BaseModuleInitializaitonContext, LocalizationResources, MigrLocalizationErorrs> {
    
    public get moduleName(): string {
        return 'eau-documents-migr';
    }
}
