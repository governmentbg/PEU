...
import { ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataUI } from '../ui/section-forms/ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataUI';
import { ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataValidator } from '../validations/ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataValidator';
import { moduleContext } from '../ModuleContext';

export class ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensManager
    extends ApplicationFormManagerBase<ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensVM>{

    //#region ApplicationFormManagerBase

    protected createDocument(obj: any): ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensVM {
        return new ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensVM(obj);
    }
    ...
    protected createSections(validationContext: DocumentFormValidationContext): Section[] {
        ...
        circumstances.formUICmp = ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataUI;
        circumstances.validator = new ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataValidator();
