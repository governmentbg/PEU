...
import { ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataUI } from '../ui/section-forms/ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataUI';
import { ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataValidator } from '../validations/ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataValidator';
import { moduleContext } from '../ModuleContext';

export class ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaManager
    extends ApplicationFormManagerBase<ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaVM>{

    //#region ApplicationFormManagerBase

    protected createDocument(obj: any): ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaVM {
        return new ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaVM(obj);
    }
    ...
    protected createSections(validationContext: DocumentFormValidationContext): Section[] {
        ...
        circumstances.formUICmp = ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataUI;
        circumstances.validator = new ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataValidator();
        ...
        if (ObjectHelper.isStringNullOrEmpty(result)) {
            switch (templateFieldKey) {
                case '{APPLICANT_PERMANENT_ADDRESS}':
                    {
                        let adr = this.documentForm.circumstances.permanentAddress;
