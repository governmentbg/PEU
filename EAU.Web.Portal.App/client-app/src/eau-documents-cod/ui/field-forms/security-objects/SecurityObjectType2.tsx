...
import { SecurityType, ProtectionPersonsProperty, AccessRegimeType, ControlType } from "../../../models/ModelsAutoGenerated";
...
interface SecurityObjectType2Props extends BaseProps, AsyncUIProps, ApplicationFormManagerProps {
    isForTermination: boolean
}

@observer export class SecurityObjectType2Impl extends EAUBaseComponent<SecurityObjectType2Props, ProtectionPersonsProperty>{
    ...
    constructor(props: SecurityObjectType2Props) {
        super(props);
...
export const SecurityObjectType2 = withAsyncFrame(withDocumentFormManager(SecurityObjectType2Impl));
