...
namespace EAU.KOS.Documents.Domain.Models.Forms
{
	...
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3052")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3052", IsNullable = false)]
	public partial class NotificationForFirearm : IApplicationForm
	{
		...
		private NotificationForFirearmData notificationForFirearmDataField;
		...
		public NotificationForFirearmData NotificationForFirearmData
		{
			get
			{
				return this.notificationForFirearmDataField;
			}
			set
			{
				this.notificationForFirearmDataField = value;
			}
		}
