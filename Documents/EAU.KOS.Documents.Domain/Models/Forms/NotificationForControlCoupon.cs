...
namespace EAU.KOS.Documents.Domain.Models.Forms
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3260")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3260", IsNullable = false)]
    public partial class NotificationForControlCoupon : IApplicationForm
    {
        ...
        private NotificationForControlCouponData notificationForControlCouponDataField;
        ...
        public NotificationForControlCouponData NotificationForControlCouponData
        {
            get
            {
                return this.notificationForControlCouponDataField;
            }
            set
            {
                this.notificationForControlCouponDataField = value;
            }
        }
