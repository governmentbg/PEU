...
{
    internal class ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponService :
       ApplicationFormServiceBase<ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCoupon, ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponVM>
    {
        ...
        public ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponService(IServiceProvider serviceProvider
        ...
        protected override string DocumentTypeUri => DocumentTypeUrisKAT.ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCoupon;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3157_ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCoupon.xslt",
        ...
        protected async override Task<OperationResult> InitializeApplicationFormInternalAsync(ApplicationFormInitializationRequest request, CancellationToken cancellationToken)
        {
            ...
            var app = (ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponVM)request.Form;
            ...
            if (app != null)
            {
                ...
                {
                    app.Circumstances = new ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponDataVM();
        ...
        protected override async Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var application = (ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponVM)request.FormData.Form;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "afiododlcc:ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCoupon/afiododlcc:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                    {"afiododlcc", "http://ereg.egov.bg/segment/R-3157"},
