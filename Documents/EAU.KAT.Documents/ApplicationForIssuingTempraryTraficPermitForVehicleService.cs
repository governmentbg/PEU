...
{
    internal class ApplicationForIssuingTempraryTraficPermitForVehicleService :
       ApplicationFormServiceBase<ApplicationForIssuingTempraryTraficPermitForVehicle, ApplicationForIssuingTempraryTraficPermitForVehicleVM>
    {
        public ApplicationForIssuingTempraryTraficPermitForVehicleService(IServiceProvider serviceProvider) 
            : base(serviceProvider)
        {
        }

        protected override string DocumentTypeUri => DocumentTypeUrisKAT.ApplicationForIssuingTempraryTraficPermitForVehicle;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3317_ApplicationForIssuingTempraryTraficPermitForVehicle.xslt",
        ...
        {
            //MVREAU2020-1582
            var app = (ApplicationForIssuingTempraryTraficPermitForVehicleVM)request.Form;
        ...
        protected override async Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (ApplicationForIssuingTempraryTraficPermitForVehicleVM)request.FormData.Form;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "afittpfv:ApplicationForIssuingTempraryTraficPermitForVehicle/afittpfv:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                    {"afittpfv", "http://ereg.egov.bg/segment/R-3317"},
