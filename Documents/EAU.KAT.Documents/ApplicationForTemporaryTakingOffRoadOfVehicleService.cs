...
{
    internal class ApplicationForTemporaryTakingOffRoadOfVehicleService :
       ApplicationFormServiceBase<ApplicationForTemporaryTakingOffRoadOfVehicle, ApplicationForTemporaryTakingOffRoadOfVehicleVM>
    {
        public ApplicationForTemporaryTakingOffRoadOfVehicleService(IServiceProvider serviceProvider) 
            : base(serviceProvider)
        {
        }

        protected override string DocumentTypeUri => DocumentTypeUrisKAT.ApplicationForTemporaryTakingOffRoadOfVehicle;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3318_ApplicationForTemporaryTakingOffRoadOfVehicle.xslt",
        ...
        {
            //MVREAU2020-1582
            var app = (ApplicationForTemporaryTakingOffRoadOfVehicleVM)request.Form;
        ...
        protected override async Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (ApplicationForTemporaryTakingOffRoadOfVehicleVM)request.FormData.Form;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "afttorov:ApplicationForTemporaryTakingOffRoadOfVehicle/afttorov:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                    {"afttorov", "http://ereg.egov.bg/segment/R-3318"},
