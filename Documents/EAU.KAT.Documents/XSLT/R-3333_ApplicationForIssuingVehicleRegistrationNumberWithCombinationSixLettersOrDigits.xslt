      ...
      <body>
        <table align="center" cellpadding="5" width= "700px">
          ...
          <tbody>
            ...
            <tr>
              <td colspan ="2">
                Моля, да получа национална&#160;<xsl:value-of select="APP:ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData/DATA:AISKATVehicleTypeName"/>&#160;с регистрационен номер&#160;
                <xsl:if test="APP:ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData/DATA:PlatesContentType = '1'">с 4 цифри&#160;<xsl:value-of  select="APP:ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData/DATA:WishedRegistrationNumber"/></xsl:if>
                <xsl:if test="APP:ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData/DATA:PlatesContentType = '2'">с комбинация от 6 букви и/или цифри&#160;<xsl:value-of  select="APP:ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData/DATA:ProvinceCode"/><xsl:value-of  select="APP:ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData/DATA:WishedRegistrationNumber"/></xsl:if>
              </td>
            </tr>
