<xsl:stylesheet version="1.0" xmlns:APP="http://ereg.egov.bg/segment/R-3311"
  ...
  <xsl:template match="APP:ApplicationForTerminationOfVehicleRegistration">
          ...
          <tbody>
            ...
            <xsl:choose>
              <xsl:when test="APP:VehicleDataRequest/VDR:Reasons/VDR:Reason/R:Name">
                <tr>
                  <td colspan="2">
                    По причина:&#160;<xsl:value-of  select="APP:VehicleDataRequest/VDR:Reasons/VDR:Reason/R:Name"/>
                  </td>
                </tr>
              </xsl:when>
            </xsl:choose>
