...
{
    internal class ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateService :
       ApplicationFormServiceBase<ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate, ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateVM>
    {
        public ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateService(IServiceProvider serviceProvider) 
            : base(serviceProvider)
        {
        }

        protected override string DocumentTypeUri => DocumentTypeUrisKAT.ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3316_ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate.xslt",
        ...
        {
            //MVREAU2020-1582
            var app = (ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateVM)request.Form;
        ...
        protected override async Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateVM)request.FormData.Form;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "afiodovrc:ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate/afiodovrc:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                    {"afiodovrc", "http://ereg.egov.bg/segment/R-3316"},
