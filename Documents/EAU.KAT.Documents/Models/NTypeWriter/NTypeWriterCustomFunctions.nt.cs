...
namespace EAU.KAT.Documents.Models.NTypeWriter
{
    class NTypeWriterCustomFunctions
    {
        ...
        {
            "DocumentFor",
            "OwnershipCertificateReason",
            "ANDCertificateReason",
            "RegistrationCertificateTypeNomenclature",
            "PersonEntityChoiceType",
            "CouponDuplicateIssuensReason",
            "VehicleOwnershipChangeType",
            "VehicleOwnerAdditionalCircumstances",
            "PersonEntityFarmerChoiceType",
            "PlatesContentTypes"
        };
        ...
        {
            "ApplicationForIssuingDocumentofVehicleOwnershipVM",
            "ApplicationForIssuingDocumentofVehicleOwnershipDataVM",
            "ApplicationForIssuingDocumentofVehicleOwnershipDataRegistrationAndMakeVM",
            "ApplicationForIssuingDocumentForRightsAndImposedPenaltiesOfVehicleDriverDataVM",
            "ApplicationForIssuingDocumentForRightsAndImposedPenaltiesOfVehicleDriverVM",
            "RequestForDecisionForDealVM",
            "RequestForDecisionForDealDataVM",
            "VehicleOwnerDataVM",
            "VehicleBuyerDataVM",
            "PersonDataVM",
            "PersonData",
            "EntityData",
            "PersonIdentifierVM",
            "VehicleRegistrationDataVM",
            "PersonEntityDataVM",
            "EntityDataVM",
            "RequestForApplicationForIssuingDuplicateDrivingLicenseVM",
            "CertificateOfVehicleOwnershipVM",
            "VehicleDataVM",
            "VehicleDataItemVM",
            "VehicleOwnerInformationItemVM",
            "VehicleOwnerAddress",
            "VehicleDataItemVehicleSuspension",
            "ReportForChangingOwnershipVM",
            "VehicleRegistrationData",
            "ReportForChangingOwnershipOldOwnersDataVM",
            "ReportForChangingOwnershipNewOwnersDataVM",
            "ReportForChangingOwnershipGuaranteeFund",
            "Status",
            "ReportForChangingOwnershipOldOwnersDataOldOwnersVM",
            "ReportForChangingOwnershipNewOwnersDataNewOwnersVM",
            "VehicleCategory",
            "CertificateAttestingToTheRightsAndPenaltiesOfVehicleDriverVM",
            "DataForPrintSRMPSVM",
            "DataForPrintSRMPSDataVM",
            "ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponVM",
            "ApplicationForIssuingOfDuplicateOfDrivingLicenseControlCouponDataVM",
            "ApplicationForIssuingOfControlCouponForDriverWithNoPenaltiesVM",
            "ApplicationForIssuingOfControlCouponForDriverWithNoPenaltiesDataVM",
            "ApplicationForTerminationOfVehicleRegistrationVM",
            "ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateVM",
            "VehicleDataRequestVM",
            "AISKATReason",
            "OwnersCollectionVM",
            "OwnerVM",
            "ApplicationForIssuingTempraryTraficPermitForVehicleVM",
            "ApplicationForTemporaryTakingOffRoadOfVehicleVM",
            "ApplicationForCommissioningTemporarilySuspendedVehicleVM",
            "ReportForVehicleVM",
            "ReportForVehicleRPSSVehicleDataVM",
            "ReportForVehicleRPSSVehicleDataOwnersVM",
            "ReportForVehicleOwnersVM",
            "ReportForVehiclePeriodicTechnicalCheck",
            "ReportForVehicleGuaranteeFund",
            "ReportForVehicleRPSSVehicleDataOwners",
            "ReportForVehicleEUCARISData",
            "DeclarationForLostSRPPSVM",
            "DeclarationForLostSRPPSData",
            "ApplicationForMountingOfRegistrationPlatesAndOrIdentificationOfVehiclesVM",
            "ApplicationForMountingOfRegistrationPlatesAndOrIdentificationOfVehiclesDataVM",
            "ApplicationForIssuingOfTemporaryRegistrationPlatesToMerchantsVM",
            "ApplicationForIssuingOfTemporaryRegistrationPlatesToMerchantsDataVM",
            "AuthorizedPersonCollectionVM",
            "ApplicationForIssuingOfTemporaryRegistrationPlatesToMerchantsDataAuthorizedPersons",
            "MerchantData",
            "MerchantDataCompanyCase",
            "ApplicationForChangeRegistrationOfVehiclesVM",
            "ApplicationForChangeRegistrationOfVehiclesDataVM",
            "VehicleRegistrationChangeWithBarterVM",
            "VehicleRegistrationChangeVM",
            "ApplicationForInitialVehicleRegistrationVM",
            "ApplicationForInitialVehicleRegistrationDataVM",
            "ApplicationForInitialVehicleRegistrationDataVehicleIdentificationData",
            "ApplicationForInitialVehicleRegistrationDataOwnersCollectionVM",
            "InitialVehicleRegistrationUserOrOwnerOfSRMPSVM",
            "InitialVehicleRegistrationOwnerDataVM",
            "ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsVM",
            "ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsDataVM",
            "NotificationForTemporaryRegistrationPlatesVM",
            "ReportForChangingOwnershipV2VM",
            "ReportForChangingOwnershipV2ChangeWithBarterVM",
            "ReportForChangingOwnershipV2ChangeVM",
            "ReportForChangingOwnershipV2VehicleDataPeriodicTechnicalCheck",
            "ReportForChangingOwnershipV2VehicleDataGuaranteeFund",
            "ReportForChangingOwnershipV2VehicleDataVM",
            "ApplicationForIssuingDriverLicenseVM",
            "ApplicationForIssuingDriverLicenseDataVM",
        };
        ...
        {
            "EAU.KAT.Documents.Domain.Models",
            "EAU.KAT.Documents.Domain.Models.Forms",
            "EAU.KAT.Documents.Models.Forms",
            "EAU.KAT.Documents.Models",
            "EAU.KAT.Documents.Models.Forms.DocumentForms"
        };
