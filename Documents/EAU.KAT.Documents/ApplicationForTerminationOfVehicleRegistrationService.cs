...
{
    internal class ApplicationForTerminationOfVehicleRegistrationService :
       ApplicationFormServiceBase<ApplicationForTerminationOfVehicleRegistration, ApplicationForTerminationOfVehicleRegistrationVM>
    {
        public ApplicationForTerminationOfVehicleRegistrationService(IServiceProvider serviceProvider) 
            : base(serviceProvider)
        {
        }

        protected override string DocumentTypeUri => DocumentTypeUrisKAT.ApplicationForTerminationOfVehicleRegistration;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3311_ApplicationForTerminationOfVehicleRegistration.xslt",
        ...
        {
            //MVREAU2020-1582
            var app = (ApplicationForTerminationOfVehicleRegistrationVM)request.Form;
        ...
        protected override async Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (ApplicationForTerminationOfVehicleRegistrationVM)request.FormData.Form;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "aftovr:ApplicationForTerminationOfVehicleRegistration/aftovr:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                    {"aftovr", "http://ereg.egov.bg/segment/R-3311"},
