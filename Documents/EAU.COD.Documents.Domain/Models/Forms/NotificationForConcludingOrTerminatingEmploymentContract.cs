...
namespace EAU.COD.Documents.Domain.Models.Forms
{
	...
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3150")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3150", IsNullable = false)]
	public partial class NotificationForConcludingOrTerminatingEmploymentContract : IApplicationForm
	{
		...
		private NotificationForConcludingOrTerminatingEmploymentContractData notificationForConcludingOrTerminatingEmploymentContractDataField;
		...
		public NotificationForConcludingOrTerminatingEmploymentContractData NotificationForConcludingOrTerminatingEmploymentContractData
		{
			get
			{
				return this.notificationForConcludingOrTerminatingEmploymentContractDataField;
			}
			set
			{
				this.notificationForConcludingOrTerminatingEmploymentContractDataField = value;
			}
		}
