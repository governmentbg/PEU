...
namespace EAU.COD.Documents.Domain.Models.Forms
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3108")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3108", IsNullable = false)]
    public partial class RequestForIssuingLicenseForPrivateSecurityServices : IApplicationForm
    {
        ...
        private RequestForIssuingLicenseForPrivateSecurityServicesData requestForIssuingLicenseForPrivateSecurityServicesDataField;
        ...
        public RequestForIssuingLicenseForPrivateSecurityServicesData RequestForIssuingLicenseForPrivateSecurityServicesData
        {
            get
            {
                return this.requestForIssuingLicenseForPrivateSecurityServicesDataField;
            }
            set
            {
                this.requestForIssuingLicenseForPrivateSecurityServicesDataField = value;
            }
        }
