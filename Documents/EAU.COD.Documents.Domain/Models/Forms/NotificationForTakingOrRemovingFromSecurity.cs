...
namespace EAU.COD.Documents.Domain.Models.Forms
{
	[System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.18020")]
	[System.SerializableAttribute()]
	[System.Diagnostics.DebuggerStepThroughAttribute()]
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3160")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3160", IsNullable = false)]
	public partial class NotificationForTakingOrRemovingFromSecurity : IApplicationForm
	{
		...
		private NotificationForTakingOrRemovingFromSecurityData notificationForTakingOrRemovingFromSecurityDataField;
		private SecurityObjectsData securityObjectsDataField;
		...
		public NotificationForTakingOrRemovingFromSecurityData NotificationForTakingOrRemovingFromSecurityData
		{
			get
			{
				return this.notificationForTakingOrRemovingFromSecurityDataField;
			}
			set
			{
				this.notificationForTakingOrRemovingFromSecurityDataField = value;
			}
		}
		public SecurityObjectsData SecurityObjectsData
		{
			get
			{
				return this.securityObjectsDataField;
			}
			set
			{
				this.securityObjectsDataField = value;
			}
		}
