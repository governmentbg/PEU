...
{
    public class EAUCODDocumentsSchemaStore : CompositeXmlSchemaStoreBase
    {
        private bool _getWeakenedSchemasChanges;

        #region Constructors

        public EAUCODDocumentsSchemaStore(bool getWeakenedSchemasChanges)
        {
        ...
        private class SchemasEmbededResourceFileSchemaStore : EmbededResourceFileSchemaStore
        {
            ...
            {
                get { return "EAU.COD.Documents.Domain.Validations.XSDSchemas.Schemas.(.*).xsd"; }
            }

            protected override string WeakenedSchemasRegex
            {
                get { return "EAU.COD.Documents.Domain.Validations.XSDSchemas.WeakenedSchemas.(.*).xsd"; }
            }
        }
