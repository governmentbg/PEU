      ...
      <body>
        ...
        <table align="center" cellpadding="5" width= "700px" >
          ...
          <tr>
            ...
            <td width="50%">
				<xsl:value-of select="CAEFRIID:Official/CAEFRIID:Position" />&#160;<xsl:value-of select="CAEFRIID:Official/CAEFRIID:PersonNames/NM:First/." />&#160;<xsl:value-of select="CAEFRIID:Official/CAEFRIID:PersonNames/NM:Last/." />
            </td>
