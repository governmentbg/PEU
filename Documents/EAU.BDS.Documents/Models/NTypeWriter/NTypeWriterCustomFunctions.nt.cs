...
namespace EAU.BDS.Documents.Models.NTypeWriter
{
    class NTypeWriterCustomFunctions
    {
        ...
        private readonly static string[] includedEnums = new string[]
        {
            "AddressForIssuing",
            "IssueDocumentFor",
            "DataContainsInCertificateNomenclature",
            "BulgarianIdentityDocumentTypes",
            "IssuingBgPersonalDocumentReasonNomenclature",
        };
        ...
        {
            "ApplicationForIssuingDocumentVM",
            "ApplicationForIssuingDocumentDataVM",
            "ForeignIdentityBasicDataVM",
            "ForeignerParentDataVM",
            "ForeignerSpouseDataVM",
            "ParentDataVM",
            "SpouseDataVM",
            "ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaVM",
            "ApplicationForIssuanceOfIdentityDocumentsAndRPOFInTheRepublicOfBulgariaDataVM",
            "ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensVM",
            "ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataVM",
            "ApplicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensVM",
            "ApplicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensDataVM",
            "RequestForApplyingForServiceForIssuingOfBulgarianCitizensIdentityCardOrPassportVM",
            "RequestForApplyingForServiceForIssuingOfBCICardOrPassportDataVM",
            "DocumentToBeIssuedForVM",
            "IssuedBulgarianIdentityDocumentsInPeriodVM",
            "OtherInformationConnectedWithIssuedBulgarianIdentityDocumentsVM",
            "ForeignCitizenDataVM",
            "CertificateAttestingToEventsAndFactsRelatedToTheIssuanceOfIdentityDocumentsInZBLDVM",
            "IdentityDocumentData",
            "DocumentNumber",
            "IssuedBulgarianIdentityDocumentInfo",
            "DeclarationUndurArticle17VM",
            "DeclarationUndurArticle17Data",
            "IssuingBgPersonalDocumentReasonData",
            "InvitationToDrawUpAUANVM"
        };
        ...
        {
            "EAU.BDS.Documents.Domain.Models",
            "EAU.BDS.Documents.Models.Forms",
            "EAU.BDS.Documents.Models"
        };
