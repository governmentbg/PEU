...
{
    internal class ApplicationByFormAnnex9Service : ApplicationFormServiceBase<ApplicationByFormAnnex9, ApplicationByFormAnnex9VM>
    {
        public ApplicationByFormAnnex9Service(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }

        protected override string DocumentTypeUri => DocumentTypeUrisKOS.ApplicationByFormAnnex9;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3016_ApplicationByFormAnnex9.xslt",
        ...
        protected async override Task<OperationResult> InitializeApplicationFormInternalAsync(ApplicationFormInitializationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (ApplicationByFormAnnex9VM)request.Form;
            var service = GetService<IServices>().Search().Single(s => s.ServiceID == request.ServiceID);
            ...
            if (form.Circumstances == null)
                form.Circumstances = new ApplicationByFormAnnex9DataVM();
        ...
        protected async override Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (ApplicationByFormAnnex9VM)request.FormData.Form;
            ...
            if (form.Circumstances.ServicesWithOuterDocumentForThirdPerson && form.Circumstances.IsRecipientEntity)
            {
        ...
        {
            var applicationForm = domainForm as ApplicationByFormAnnex9;
            ...
            ret.Circumstances.IssuingDocument = applicationForm.ApplicationByFormAnnex9Data.IssuingDocument;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "aipsgap:ApplicationByFormAnnex9/aipsgap:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                   {"aipsgap", "http://ereg.egov.bg/segment/R-3016" },
