...
namespace EAU.KOS.Documents.Models.NTypeWriter
{
    class NTypeWriterCustomFunctions
    {
        ...
        {
              "ApplicationByFormAnnex9VM",
              "ApplicationByFormAnnex9DataVM",
              "ApplicationByFormAnnex10VM",
              "ApplicationByFormAnnex10DataVM",
              "NotificationForNonFirearmVM",
              "NotificationForNonFirearmDataVM",
              "NotificationForFirearmVM",
              "NotificationForFirearmDataVM",
              "NotificationForControlCouponVM",
              "LicenseInfo",
              "Ammunition",
              "Pyrotechnics",
              "Explosives",
              "Firearms",
              "ControlCouponDataItemVM",
              "NotificationForControlCouponDataVM",
              "TechnicalSpecificationOfWeapon",
        };
        ...
        {
            "EAU.KOS.Documents.Domain.Models",
            "EAU.KOS.Documents.Models.Forms",
            "EAU.KOS.Documents.Models"
        };
