...
{
    internal class NotificationForFirearmService : ApplicationFormServiceBase<NotificationForFirearm, NotificationForFirearmVM>
    {
        public NotificationForFirearmService(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }

        protected override string DocumentTypeUri => DocumentTypeUrisKOS.NotificationForFirearm;
        ...
        protected override PrintPreviewData PrintPreviewData
        {
            get
            {
                ...
                {
                    Xslt = "R-3052_NotificationForFirearm.xslt",
        ...
        protected async override Task<OperationResult> InitializeApplicationFormInternalAsync(ApplicationFormInitializationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (NotificationForFirearmVM)request.Form;
            var service = GetService<IServices>().Search().Single(s => s.ServiceID == request.ServiceID);
            ...
            if (form.Circumstances == null)
                form.Circumstances = new NotificationForFirearmDataVM();
        ...
        protected async override Task<IErrorCollection> ValidateApplicationFormInternalAsync(ApplicationFormValidationRequest request, CancellationToken cancellationToken)
        {
            ...
            var form = (NotificationForFirearmVM)request.FormData.Form;
        ...
        public override string SignatureXpath
        {
            get
            {
                return "nff:NotificationForFirearm/nff:ElectronicAdministrativeServiceFooter/xmldsig:XMLDigitalSignature";
            }
        }
        ...
        public override Dictionary<string, string> SignatureXPathNamespaces
        {
            get
            {
                ...
                {
                   {"nff", "http://ereg.egov.bg/segment/R-3052" },
