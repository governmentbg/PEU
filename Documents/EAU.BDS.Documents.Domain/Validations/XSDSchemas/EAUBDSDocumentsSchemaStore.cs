...
{
    public class EAUBDSDocumentsSchemaStore : CompositeXmlSchemaStoreBase
    {
        private bool _getWeakenedSchemasChanges;

        #region Constructors

        public EAUBDSDocumentsSchemaStore(bool getWeakenedSchemasChanges)
        {
        ...
        private class SchemasEmbededResourceFileSchemaStore : EmbededResourceFileSchemaStore
        {
            ...
            {
                get { return "EAU.BDS.Documents.Domain.Validations.XSDSchemas.Schemas.(.*).xsd"; }
            }

            protected override string WeakenedSchemasRegex
            {
                get { return "EAU.BDS.Documents.Domain.Validations.XSDSchemas.WeakenedSchemas.(.*).xsd"; }
            }
        }
