...
namespace EAU.BDS.Documents.Domain.Models.Forms
{
	...
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3030")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3030", IsNullable = false)]
	public partial class ApplicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizens : IApplicationForm
	{
		...
		private ApplicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensData applicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensDataField;
		...
		[System.Xml.Serialization.XmlArrayItemAttribute("IdentificationDocumentType", typeof(IdentityDocumentType), IsNullable = false)]
		...
		public ApplicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensData ApplicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensData
		{
			get
			{
				return this.applicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensDataField;
			}
			set
			{
				this.applicationForIssuingResidencePermitAndDrivingLicenseForEuropeanCitizensDataField = value;
			}
		}
