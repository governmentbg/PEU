...
namespace EAU.PBZN.Documents.Domain.Models.Forms
{
	...
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3107")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3107", IsNullable = false)]
	public partial class ApplicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGasses : IApplicationForm
	{
		...
		private ApplicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGassesData applicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGassesDataField;
		...
		public ApplicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGassesData ApplicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGassesData
		{
			get
			{
				return this.applicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGassesDataField;
			}
			set
			{
				this.applicationForIssuingOrRenewingCertificateToWorkWithFluorinatedGreenhouseGassesDataField = value;
			}
		}
