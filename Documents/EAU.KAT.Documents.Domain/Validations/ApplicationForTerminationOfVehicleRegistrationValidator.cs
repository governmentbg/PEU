...
{
    public class ApplicationForTerminationOfVehicleRegistrationValidator : EAUValidator<ApplicationForTerminationOfVehicleRegistration>
    {
        public ApplicationForTerminationOfVehicleRegistrationValidator()
        {
        ...
        public override ValidationResult Validate(ValidationContext<ApplicationForTerminationOfVehicleRegistration> context)
        {
            ValidationResult result = base.Validate(context);
            ApplicationForTerminationOfVehicleRegistration instanceToValidate = context.InstanceToValidate;
