...
{
    public class ApplicationForChangeRegistrationOfVehiclesValidator : EAUValidator<ApplicationForChangeRegistrationOfVehicles>
    {
        public ApplicationForChangeRegistrationOfVehiclesValidator()
        {
            ...
            EAURuleFor(m => m.ApplicationForChangeRegistrationOfVehiclesData).RequiredSection().EAUInjectValidator();
        }
    }
}