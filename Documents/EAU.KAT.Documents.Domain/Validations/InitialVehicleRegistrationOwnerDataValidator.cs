...
{
    public class InitialVehicleRegistrationOwnerDataValidator : EAUValidator<InitialVehicleRegistrationOwnerData>
    {
        public InitialVehicleRegistrationOwnerDataValidator()
        {
