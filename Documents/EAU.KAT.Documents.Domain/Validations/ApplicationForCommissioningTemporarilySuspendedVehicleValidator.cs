...
{
    public class ApplicationForCommissioningTemporarilySuspendedVehicleValidator : EAUValidator<ApplicationForCommissioningTemporarilySuspendedVehicle>
    {
        public ApplicationForCommissioningTemporarilySuspendedVehicleValidator()
        {
        ...
        public override ValidationResult Validate(ValidationContext<ApplicationForCommissioningTemporarilySuspendedVehicle> context)
        {
            ValidationResult result = base.Validate(context);
            ApplicationForCommissioningTemporarilySuspendedVehicle instanceToValidate = context.InstanceToValidate;
