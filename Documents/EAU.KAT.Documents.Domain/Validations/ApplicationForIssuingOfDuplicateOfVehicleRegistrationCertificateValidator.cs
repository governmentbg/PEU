...
{
    public class ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateValidator : EAUValidator<ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate>
    {
        public ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificateValidator()
        {
        ...
        public override ValidationResult Validate(ValidationContext<ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate> context)
        {
            ValidationResult result = base.Validate(context);
            ApplicationForIssuingOfDuplicateOfVehicleRegistrationCertificate instanceToValidate = context.InstanceToValidate;
