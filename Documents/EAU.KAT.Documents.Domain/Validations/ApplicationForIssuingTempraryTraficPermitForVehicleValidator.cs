...
{
    public class ApplicationForIssuingTempraryTraficPermitForVehicleValidator : EAUValidator<ApplicationForIssuingTempraryTraficPermitForVehicle>
    {
        public ApplicationForIssuingTempraryTraficPermitForVehicleValidator()
        {
        ...
        public override ValidationResult Validate(ValidationContext<ApplicationForIssuingTempraryTraficPermitForVehicle> context)
        {
            ValidationResult result = base.Validate(context);
            ApplicationForIssuingTempraryTraficPermitForVehicle instanceToValidate = context.InstanceToValidate;
