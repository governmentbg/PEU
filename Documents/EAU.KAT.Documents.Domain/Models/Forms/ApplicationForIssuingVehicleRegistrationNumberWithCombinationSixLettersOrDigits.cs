...
{
	/// <summary>
	/// Получаване на регистрационен номер за ППС с комбинация от шест букви и/или цифри по избор на клиента
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.18020")]
	[System.SerializableAttribute()]
	[System.Diagnostics.DebuggerStepThroughAttribute()]
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3333")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3333", IsNullable = false)]
	public partial class ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigits : IApplicationForm
	{
		...
		private ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData applicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsDataField;
		...
		public ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData ApplicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsData
		{
			get
			{
				return this.applicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsDataField;
			}
			set
			{
				this.applicationForIssuingVehicleRegistrationNumberWithCombinationSixLettersOrDigitsDataField = value;
			}
		}
