...
namespace EAU.KAT.Documents.Domain.Models.Forms
{
	...
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3320")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3320", IsNullable = false)]
	public partial class DeclarationForLostSRPPS : IApplicationForm
	{
		...
		private DeclarationForLostSRPPSData dataField;
		...
		public DeclarationForLostSRPPSData Data
		{
			get
			{
