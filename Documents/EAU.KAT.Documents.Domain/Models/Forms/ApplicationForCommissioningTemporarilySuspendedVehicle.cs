...
{
	/// <summary>
	/// Заявление за пускане в движение на временно спряно ППС по желание на собственика
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.18020")]
	[System.SerializableAttribute()]
	[System.Diagnostics.DebuggerStepThroughAttribute()]
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://ereg.egov.bg/segment/R-3319")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://ereg.egov.bg/segment/R-3319", IsNullable = false)]
	public partial class ApplicationForCommissioningTemporarilySuspendedVehicle : IApplicationForm
	{
		...
		private VehicleDataRequest vehicleDataRequestField;
		...
		public VehicleDataRequest VehicleDataRequest
		{
			get
			{
				return this.vehicleDataRequestField;
			}
			set
			{
				this.vehicleDataRequestField = value;
			}
		}
