...
namespace EAU.Documents.Models.NTypeWriter
{
    class NTypeWriterCustomFunctions
    {
        ...
        private readonly static string[] includedEnums = new string[]
        {
            ...
            "ElectronicServiceProviderType",
            "ElectronicServiceAuthorQualityType",
            "PersonAndEntityChoiceType",
            "ForeignEntityChoiceType",
            "PersonIdentifierChoiceType",
            "IdentityDocumentType",
            "DocumentElectronicTransportType",
            "ElectronicDocumentDiscrepancyType",
            "ChoiceType",
            "OfficialChoiceType",
            "ItemChoiceType",
            "RecipientChoiceType",
            "ForeignEntityIdentifierChoiceType",
            "ItemChoiceType1",
            "BIDPersonalIdentificationDocumentReceivePlace",
            "BIDMaritalStatus",
            "BIDEyesColor",
            "ExecutionPeriodType",
            "PersonIdentificationForeignStatut",
        };
        ...
        {
            "IdentificationPhotoAndSignatureVM",
            "EkatteAddress",
            "GRAOAddress",
            "IdentifierType",
            "EntityBasicData",
            "DigitalSignatureContainerVM",
            "ApplicationFormVMBase",
            "DocumentsWillBeIssuedMessageVM",
            "OutstandingConditionsForStartOfServiceMessageVM",
            "PaymentInstructionsVM",
            "ReceiptAcknowledgedMessageVM",
            "ReceiptAcknowledgedPaymentForMOIVM",
            "ReceiptNotAcknowledgedMessageVM",
            "RemovingIrregularitiesInstructionsVM",
            "TerminationOfServiceMessageVM",
            "ElectronicServiceApplicantVM",
            "ElectronicServiceApplicantContactData",
            "ServiceTermTypeAndApplicantReceiptVM",
            "DeclarationsVM",
            "DeclarationVM",
            "ElectronicAdministrativeServiceHeaderVM",
            "Signature",
            "RecipientGroupVM",
            "PhoneNumbers",
            "FaxNumbers",
            "ServiceApplicantReceiptDataVM",
            "ElectronicServiceProviderBasicData",
            "SigningCertificateData",
            "TimeStampInfo",
            "AuthorWithQualityVM",
            "PersonAndEntityBasicDataVM",
            "ElectronicServiceRecipientVM",
            "ServiceApplicantReceiptDataAddress",
            "ServiceApplicantReceiptDataMunicipalityAdministrationAdressVM",
            "ServiceApplicantReceiptDataUnitInAdministration",
            "ElectronicStatementAuthorVM",
            "PersonBasicDataVM",
            "ForeignCitizenBasicData",
            "ForeignEntityBasicDataVM",
            "PersonNames",
            "PersonIdentifier",
            "IdentityDocumentBasicDataVM",
            "ForeignCitizenNames",
            "ForeignCitizenPlaceOfBirth",
            "ForeignCitizenIdentityDocument",
            "ElectronicServiceApplicant",
            "RegisteredDocumentURI",
            "AISCaseURI",
            "PoliceDepartment",
            "ElectronicServiceProviderBasicDataVM",
            "AISCaseURIVM",
            "OutstandingConditionsForStartOfServiceMessageGrounds",
            "DeadlineVM",
            "ReceiptAcknowledgedMessageRegisteredByVM",
            "OfficialVM",
            "RemovingIrregularitiesInstructionsIrregularitiesVM",
            "TerminationOfServiceMessageGrounds",
            "RecipientGroup",
            "ReceiptAcknowledgedMessageRegisteredByOfficerVM",
            "ElectronicStatementAuthor",
            "ElectronicServiceRecipient",
            "AISUserNamesVM",
            "PersonBasicData",
            "ForeignEntityBasicData",
            "IdentityDocumentBasicData",
            "PersonAddress",
            "UnitInfo",
            "DocumentMustServeToVM",
            "CitizenshipVM",
            "PersonalInformationVM",
            "EntityAddress",
            "IdentityDocumentForeignCitizenBasicData",
            "GenderDataGender",
            "GenderData",
            "PlaceOfBirthAbroad",
            "ServiceIrregularity",
            "RefusalVM",
            "ActionsTakenMessageVM",
            "PersonNamesLatin",
            "PersonIdentificationData",
            "PersonDataExtendedVM",
            "IssuerCountryVM",
            "TravelDocumentVM",
            "ApplicationForWithdrawServiceVM",
            "ApplicationForWithdrawServiceDataVM",
            "OutstandingConditionsForWithdrawServiceMessageGrounds",
            "OutstandingConditionsForWithdrawServiceMessageVM"
        };
        ...
        {
            "EAU.Documents.Domain.Models",
            "EAU.Documents.Models.Forms",
            "EAU.Documents.Models",
            "EAU.Services.Nomenclatures.Models",
            "EAU.Nomenclatures.Models",
        };
