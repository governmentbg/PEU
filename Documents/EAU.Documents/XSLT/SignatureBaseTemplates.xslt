...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="SignatureHead">

    <head>
      <xsl:call-template name="SignatureStyle"/>
    </head>
  </xsl:template>

  <xsl:template name="SignatureStyle">
  ...
  <xsl:template name="DocumentSignatures">
    ...
    <xsl:if test="$Signatures">
      <xsl:for-each select="$Signatures/Signature">
        <xsl:call-template name="DocSignature">
  ...
  <xsl:template name="DocSignature">
