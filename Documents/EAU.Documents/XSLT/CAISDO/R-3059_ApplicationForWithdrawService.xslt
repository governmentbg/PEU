			...
			<body>
              ...
              <div class="flex-col">
                <p class="text-bold text-uppercase">
                  <xsl:value-of select="AFWS:DocumentTypeName" />
                </p>
              </div>
							<div class="flex-col">
								<p class="text-bold text-uppercase">
					...
					<div class="document-section">
						...
						<p>
							Адрес на електронна поща:&#160;<xsl:value-of  select="AFWS:ElectronicAdministrativeServiceHeader/EASH:ElectronicServiceApplicant/ESA:EmailAddress"/>
						</p>
					</div>
					<div class="document-section">
						...
						<p>
							УРИ на преписка:&#160;<xsl:value-of  select="AFWS:ApplicationForWithdrawServiceData/AFWSD:CaseFileURI"/>
						</p>
						<p>
							Причини за отказа:&#160;<xsl:value-of  select="AFWS:ApplicationForWithdrawServiceData/AFWSD:RefusalReasons"/>
						</p>
					</div>
				</div>
			</body>
