...
{
    public class OutstandingConditionsForStartOfServiceMessageValidator : EAUValidator<OutstandingConditionsForStartOfServiceMessage>
    {
        public OutstandingConditionsForStartOfServiceMessageValidator()
        {
