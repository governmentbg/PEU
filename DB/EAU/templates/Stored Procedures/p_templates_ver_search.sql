...
-- =============================================
CREATE PROCEDURE [templates].[p_templates_ver_search]
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[p_templates_ver_search]';
	  RETURN -1;
	END
	ELSE
	BEGIN
	  ...
	  -- ===============================================================================
		...
		SET @v_statement = N'SELECT 
				...
				FROM [templates].[templates_ver]
				WHERE 
					[is_last] = 1 AND [deactivation_ver_id] IS NULL';
