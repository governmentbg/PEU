...
-- =============================================
CREATE PROCEDURE [templates].[p_templates_ver_create]
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[p_templates_ver_create]';
	  RETURN -1;
	END
	ELSE
	BEGIN
	  BEGIN TRY
		...
		SELECT @p_template_id = NEXT VALUE FOR [templates].[seq_templates_ver];
