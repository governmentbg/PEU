...
-- =============================================
CREATE PROCEDURE [templates].[p_templates_search_multi]
...
BEGIN
	...
	BEGIN
	  ...
	  -- ===============================================================================
		...
		DECLARE @v_templates_result [templates].[tt_templates_info];

		INSERT INTO @v_templates_result
		...
		SELECT * FROM @v_templates_result;

		IF @p_load_content = 1
		BEGIN
			SELECT cnt.* FROM [templates].[templates_content] cnt
			INNER JOIN @v_templates_result tt on tt.template_id = cnt.template_id;
		END;
