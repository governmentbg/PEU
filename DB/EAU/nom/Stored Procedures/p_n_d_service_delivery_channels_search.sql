...
-- =============================================
CREATE PROCEDURE [nom].[p_n_d_service_delivery_channels_search]
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[nom].[p_n_d_service_delivery_channels_search]';
	  RETURN -1;
	END
	ELSE
	BEGIN
	  ...
	  -- ===============================================================================
		...
		SELECT [service_id]
			  ,[delivery_channel_id]			  
		  FROM [nom].[n_d_service_delivery_channels]
		 WHERE [is_last] = 1 
