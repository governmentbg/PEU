...
-- =============================================
CREATE PROCEDURE [nom].[p_n_d_languages_update]
	@p_language_id	INT,
	@p_is_active	BIT
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[nom].[p_n_d_languages_update]';
	  RETURN -1;
	END
	ELSE
	BEGIN
	  BEGIN TRY
		...
		IF @@ROWCOUNT <> 1
		BEGIN
			EXEC [dbo].[p_sys_raise_dberror] -16, '[nom].[p_n_d_languages_update]';
			RETURN -1;
		END;
