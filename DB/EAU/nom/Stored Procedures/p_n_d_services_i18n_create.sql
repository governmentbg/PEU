...
-- =============================================
CREATE PROCEDURE [nom].[p_n_d_services_i18n_create]
	@p_service_id						INT,
	@p_language_id						INT,
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[nom].[p_n_d_services_i18n_create]';
	  RETURN -1;
	END
	ELSE
	BEGIN
     ...
     VALUES
		...
		IF @@ROWCOUNT <> 1
		BEGIN
			EXEC [dbo].[p_sys_raise_dberror] -16, '[nom].[p_n_d_services_i18n_create]';
			RETURN -1;
		END;
