...
-- =============================================
CREATE PROCEDURE [nom].[p_n_d_service_terms_search]
	@p_service_id		INT,
	@p_start_index		INT,
	@p_page_size		INT,
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[nom].[p_n_d_service_terms_search]';
	  RETURN -1;
	END
	ELSE
	BEGIN
	  ...
	  -- ===============================================================================
		...
		WHERE tablename = '[nom].[n_d_labels]' OR tablename = '[nom].[n_d_service_terms]';
