...
-- =============================================
CREATE PROCEDURE [nom].[p_n_s_countries_search]
	@p_start_index		INT,
	@p_page_size		INT,
...
BEGIN
	...
	BEGIN
	  EXEC [dbo].[p_sys_raise_dberror] -1, '[nom].[p_n_s_countries_search]';
	  RETURN -1;
	END
	ELSE
	BEGIN
	  ...
	  -- ===============================================================================
		...
		WHERE tablename = '[nom].[p_n_s_countries_search]';
